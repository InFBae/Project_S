...
public abstract class RE_Gun : MonoBehaviourPunCallbacks
{
    ...
    [SerializeField] public int remainBullet;             // 총탄 개수
    [SerializeField] public int availableBullet;       // 재장전 하기 전 사용 가능한 총탄 개수 
    [SerializeField] public int curAvailavleBullet;    // 계속 사용 중인 현재 총알 개수   
