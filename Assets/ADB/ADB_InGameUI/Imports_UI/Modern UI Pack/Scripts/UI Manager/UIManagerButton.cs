        ...
        void UpdateButton()
        {
            ...
            try
            {
                if (UIManagerAsset.buttonThemeType == UIManager.ButtonThemeType.Basic)
                {
                    ...
                    else if (buttonType == ButtonType.BASIC_ONLY_ICON && overrideColors == false)
                    {
                    ...
                    else if (buttonType == ButtonType.BASIC_OUTLINE_ONLY_ICON && overrideColors == false)
                    {
                    ...
                    else if (buttonType == ButtonType.RADIAL_ONLY_ICON && overrideColors == false)
                    {
                        radialOOBackground.color = UIManagerAsset.buttonBorderColor;
                        radialOOIcon.color = UIManagerAsset.buttonFilledColor;
                    }

                    else if (buttonType == ButtonType.RADIAL_OUTLINE_ONLY_ICON && overrideColors == false)
                    {
                ...
                else if (UIManagerAsset.buttonThemeType == UIManager.ButtonThemeType.Custom)
                {
                    ...
                    else if (buttonType == ButtonType.BASIC_OUTLINE_ONLY_ICON && overrideFonts == false)
                    {
                        basicOutlineOOBorder.color = UIManagerAsset.buttonBorderColor;
