        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    if (useCustomContent.boolValue == false && bTarget.normalImage != null)
                        bTarget.normalImage.sprite = bTarget.buttonIcon;

                    else if (useCustomContent.boolValue == false && bTarget.normalImage == null)
                    {
                        GUILayout.Space(2);
