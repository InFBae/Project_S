...
namespace Michsky.UI.ModernUIPack
{
    ...
    public class IconManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Box(new GUIContent(""), customSkin.FindStyle("IM Top Header"));
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    EditorGUILayout.LabelField(new GUIContent("Icon Library"), customSkin.FindStyle("Text"), GUILayout.Width(120));
                    EditorGUILayout.PropertyField(iconLibrary, new GUIContent(""));
